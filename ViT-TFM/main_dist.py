...
def main():
    ...
    # Setup distributed training and seeds
    ...
    train_kwargs = {'batch_size': args.batch_size, 'num_workers': args.num_workers, 'pin_memory': True}
    val_kwargs = {'batch_size': args.val_batch_size, 'num_workers': args.num_workers, 'pin_memory': True}
    dataloaders = {'train': DataLoader(train_set, sampler=sampler, **train_kwargs),
                   'val': DataLoader(val_set, **val_kwargs)}
