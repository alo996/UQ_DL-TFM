...
class EventGenerator:
    ...
    def generate(self, event_num):
        f_data_disp = tables.open_file('../ViT-TFM/data/Test data/displacements_50.h5', mode='w')
        ...
        f_data_force = tables.open_file('../ViT-TFM/data/Test data/tractions_50.h5', mode='w')
